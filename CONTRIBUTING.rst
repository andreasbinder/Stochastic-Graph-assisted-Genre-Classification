...
Welcome to ``tdde13`` contributor's guide.
...
If you experience bugs or general issues with ``tdde13``, please have a look
...
You can help improve ``tdde13`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``tdde13`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``tdde13``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n tdde13 python=3 six virtualenv pytest pytest-cov
    conda activate tdde13
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/tdde13.git
    cd tdde13
...
#. Install |pre-commit|_::
   ...
   ``tdde13`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/tdde13
.. _issue tracker: https://github.com/<USERNAME>/tdde13/issues
.. <-- end -->
